...
///
/// ```rust
/// assert_eq!(1 as i8, numberkit::as_i8("1").unwrap());
/// ```
...
///
/// ```rust
/// assert_eq!(-1 as i8, numberkit::as_i8d("a", -1 as i8));
/// ```
...
///
/// ```rust
/// assert_eq!(1 as i16, numberkit::as_i16("1").unwrap());
/// ```
...
///
/// ```rust
/// assert_eq!(-1 as i16, numberkit::as_i16d("a", -1 as i16));
/// ```
...
///
/// ```rust
/// assert_eq!(1 as i32, numberkit::as_i32("1").unwrap());
/// ```
...
///
/// ```rust
/// assert_eq!(-1 as i32, numberkit::as_i32d("a", -1 as i32));
/// ```
...
///
/// ```rust
/// assert_eq!(1 as i64, numberkit::as_i64("1").unwrap());
/// ```
...
///
/// ```rust
/// assert_eq!(-1 as i64, numberkit::as_i64d("a", -1 as i64));
/// ```
...
///
/// ```rust
/// assert_eq!(1 as i128, numberkit::as_i128("1").unwrap());
/// ```
...
///
/// ```rust
/// assert_eq!(-1 as i128, numberkit::as_i128d("a", -1 as i128));
/// ```
...
///
/// ```rust
/// assert_eq!(1 as usize, numberkit::as_usized("a", 1 as usize));
/// ```
...
///
/// ```rust
/// assert_eq!(1 as u8, numberkit::as_u8d("a", 1 as u8));
/// ```
...
///
/// ```rust
/// assert_eq!(1 as u16, numberkit::as_u16d("a", 1 as u16));
/// ```
...
///
/// ```rust
/// assert_eq!(1 as u32, numberkit::as_u32d("a", 1 as u32));
/// ```
...
///
/// ```rust
/// assert_eq!(1 as u64, numberkit::as_u64d("a", 1 as u64));
/// ```
...
///
/// ```rust
/// assert_eq!(1 as u128, numberkit::as_u128("1").unwrap());
/// ```
...
///
/// ```rust
/// assert_eq!(1 as u128, numberkit::as_u128d("a", 1 as u128));
/// ```
...
///
/// ```rust
/// assert_eq!(1.2 as f32, numberkit::as_f32("1.2").unwrap());
/// ```
...
///
/// ```rust
/// assert_eq!(1.2 as f32, numberkit::as_f32d("a", 1.2 as f32));
/// ```
...
///
/// ```rust
/// assert_eq!(1.2 as f64, numberkit::as_f64("1.2").unwrap());
/// ```
...
///
/// ```rust
/// assert_eq!(1.2 as f64, numberkit::as_f64d("a", 1.2 as f64));
/// ```
